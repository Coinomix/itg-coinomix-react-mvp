...
export const getCategories = () => client.get<ArticleCaregory>('/categories');
...
export const getArticlesByCategory = (categoryId: number) => client.get<Article>('/articles?sort=publish_date:desc&populate[0]=image&populate[1]=categories&populate[2]=author');
